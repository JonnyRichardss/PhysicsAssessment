...
namespace PhysicsEngine
{
	...
	PxMaterial* CreateMaterial(PxVec3 params)
	{
		return physics->createMaterial(params.x, params.y, params.z);
	}
	...
	PxRigidDynamic* Actor::GetRigidBody()
	{
		return static_cast<PxRigidDynamic*>(Get());
	}
